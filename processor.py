...
class Processor():
    ...
    def preprocess_image(self, image, channels=3):
        ...
        # https://github.com/onnx/models/tree/main/vision/classification/mobilenet#preprocessing
    ...
    def compare(self, image1, image2):
        ...
        if similarity > self.threshold:
            return {"result": True, "score": similarity}
        else:
            return {"result": False, "score": similarity}
